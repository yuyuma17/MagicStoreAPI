...
class MagicBookList {
    ...
    let bookLists: [MagicBook] = [
        ...
        MagicBook(id: 12, name: "無所遁形術", level: 2, price: 300),
        MagicBook(id: 13, name: "火箭", level: 2, price: 300),
        ...
        MagicBook(id: 17, name: "極光雷電", level: 3, price: 500),
        MagicBook(id: 18, name: "能量感測", level: 3, price: 500),
        MagicBook(id: 19, name: "初級治癒術", level: 3, price: 500),
